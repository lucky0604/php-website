...
<head>
    ...
    <!-- Scripts -->
    <script src="{{ asset('js/app_landingpage.js') }}" defer></script>
    ...
    <!-- Styles -->
    <link href="{{ asset('css/app_landingpage.css') }}" rel="stylesheet">
</head>
<body id="page-top">
<!-- Navigation-->
<nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">SOFTTEAM</a><button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            <div class="col-lg-10 align-self-end">
                <h1 class="text-uppercase text-white font-weight-bold">We may change something.</h1>
                <hr class="divider my-4" />
            </div>
            <div class="col-lg-8 align-self-baseline">
                <p class="text-white-75 font-weight-light mb-5">we may not the best, but we can do our best.</p>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                ...
                <p class="text-white-50 mb-4">
                    We are a team with years of Software development. It's a team of remote developers. We are committed to the rapid realization of ideas for users and the completion of product development.
                </p>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 text-center">
                <div class="mt-5">
                    ...
                    <h3 class="h4 mb-2">Interface Design</h3>
                    <p class="text-muted mb-0">
                        Design more attractive interface and experience for users with our creativity.
                    </p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 text-center">
